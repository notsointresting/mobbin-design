...
bitmap assets, or post-build visual QA. Keep the main Mobbin workflow research-first:
screens for visual direction and product patterns, flows for journeys, sections for marketing pages.
...
in Claude Code and other MCP-compatible agents when
...
current brief and Mobbin research:
